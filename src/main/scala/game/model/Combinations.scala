...
trait Combinations { val name: String }
...
object Combinations {
  ...
  case object ThreeOfAKind  extends ComplexCombinations { val name = "ThreeOfAKind" }
  ...
  case object SmallStraight extends ComplexCombinations { val name = "SmallStraight" }
  case object LargeStraight extends ComplexCombinations { val name = "LargeStraight" }
